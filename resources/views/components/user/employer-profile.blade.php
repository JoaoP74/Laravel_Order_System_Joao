                                    ...
                                    <div class="col-lg-3 col-md-4">
                                        ...
                                        <div class="profile-pic-wrapper">
                                            <div class="pic-holder">
                                                ...
                                                <input class="uploadProfileInput" type="file" name="image" id="newProfilePhoto" accept="image/*" style="opacity: 0; width:0; padding:0; visibility: hidden;" readonly />
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-6">
                                                <div class="form-group form_dv_wrap">
                                                    ...
                                                    <input type="number" name="number" class="form-control" value="{{@$user->contact_no}}" readonly>
                                            ...
                                            <div class="col-6">
                                                <div class="form-group form_dv_wrap">
                                                    ...
                                                    <input type="text" name="place" class="form-control" value="{{@$user->place}}" readonly>
                                                    @if ($errors->has('place'))
                                                    <span class="text-danger">{{__('home.requiredMessage')}}<i class="fa fa-exclamation-circle" aria-hidden="true"></i></span>
                                                    @endif
                                                </div>
                                            ...
                                            <div class="col-6">
                                                <div class="form-group form_dv_wrap">
                                                    ...
                                                    <input type="text" name="vat_no" class="form-control" value="{{@$user->vat_no}}" readonly>
                                            ...
                                            <div class="col-6">
                                                <div class="form-group form_dv_wrap">
                                                    ...
                                                    <input type="text" name="site" class="form-control" value="{{@$user->site}}" readonly>
                                                    @if ($errors->has('site'))
                                                    <span class="text-danger">{{__('home.requiredMessage')}}<i class="fa fa-exclamation-circle" aria-hidden="true"></i></span>
                                                    @endif
                                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-6">
                                                <div class="form-group form_dv_wrap">
                                                    ...
                                                    <input type="text" name="thread" class="form-control" value="{{@$user->thread}}" readonly>
                                            ...
                                            <div class="col-6">
                                                <div class="form-group form_dv_wrap">
                                                    ...
                                                    <input type="text" name="file_emb" class="form-control" value="{{@$user->emb_fileType}}" readonly>
                                            ...
                                            <div class="col-6">
                                                <div class="form-group form_dv_wrap">
                                                    ...
                                                    <input type="text" name="file_vect" class="form-control" value="{{@$user->vec_fileType}}" readonly>
                                            ...
                                            <div class="col-6">
                                                <div class="form-group form_dv_wrap">
                                                    ...
                                                    <input type="text" name="thread_instruction" class="form-control" value="{{@$user->thread_notes}}" readonly>
                                            ...
                                            <div class="col-6">
                                                <div class="form-group form_dv_wrap">
                                                    ...
                                                    <input type="text" name="thread_cut" class="form-control" value="{{@$user->thread_cut_notes}}" readonly>
                                            ...
                                            <div class="col-6">
                                                <div class="form-group form_dv_wrap">
                                                    ...
                                                    <input type="text" name="needle_instruction" class="form-control" value="{{@$user->needle_notes}}" readonly>
                                            ...
                                            <div class="col-6">
                                                <div class="form-group form_dv_wrap">
                                                    ...
                                                    <input type="text" name="font_instruction" class="form-control" value="{{@$user->font_notes}}" readonly>
                                            ...
                                            <div class="col-6">
                                                <div class="form-group form_dv_wrap">
                                                    ...
                                                    <input type="text" name="special_instruction" class="form-control" value="{{@$user->special_notes}}" readonly>
