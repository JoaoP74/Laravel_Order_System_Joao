                    ...
                    <div class="login_wrap">
                        ...
                        <form method="POST" auto-complete="off" action="{{__('routes.admin-sign-in')}}">
                            ...
                            <div class="row">
                                ...
                                <!-- Password input -->
                                <div class="form_dv">
                                    <input type="password" id="form3Example4" class="form-control" autocomplete="new-password" name="password" />
                                    @if ($errors->has('password'))
                                    <span class="text-danger">{{ $errors->first('password') }}<i class="fa fa-exclamation-circle" aria-hidden="true"></i></span>
                                    @endif
                                </div>
