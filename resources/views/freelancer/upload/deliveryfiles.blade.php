                        ...
                        <form id="delivery_files">
                            <div class="tab">
                                ...
                                <div class="row additional_wrap">
                                    ...
                                    <div class="col-md-6">
                                        <div class="additional_btn">
                                            <button type="button" id="add-file-btn" class="btn btn-outline-success ">Additional file</button>
                                        </div>
                                    </div>
                                </div>
                                <p id="file-container" style="display: flex; flex-direction:column; gap:18px" class="form-group">
                                    ...
                                    <input type="hidden" name="customerid" class="form-control " value="{{@$orderdata->user_id}}">
                                    <input type="hidden" name="order_id" class="form-control " value="{{@$orderid}}">
                                    <input type="hidden" name="freelancerid" class="form-control " value="{{@$orderdata->category_id}}">
                            ...
                            <div class="row">
                                <div class="col-12 ">
                                    <div class="upload_btn">
                                        <a href="#" id="loading" class="btn btn-primary btn-block send-btn loading-btn" style="display:none;border-color: #54b4d3;color: #54b4d3;font-weight: bold;">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12" style="cursor:pointer;">
                                    @for($i=0;$i < count($data); $i++) <div class="row">
                                        <div class="col-md-12">
                                            <div class="upload-file-row">
                                                ...
                                                <span><a href="{{@$data[$i]}}" class="download-btn" download> download</a></span>
                                                <span><a href="{{__('routes.freelancer-delete-files').$i.'/'.@$orderdata->id}}" class="btn btn-danger"><i class="fa-solid fa-xmark"></i></a></span>
