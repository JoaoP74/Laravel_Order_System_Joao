                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group form_dv_wrap">
                                                    ...
                                                    @if ($errors->has('name'))
                                                    <span class="text-danger">{{ $errors->first('name') }}<i class="fa fa-exclamation-circle" aria-hidden="true"></i></span>
                                                    @endif
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="form-group form_dv_wrap">
                                                    ...
                                                    <span class="text-danger">{{ $errors->first('number') }}<i class="fa fa-exclamation-circle" aria-hidden="true"></i></span>
                                                    @endif
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="form-group form_dv_wrap">
                                                    ...
                                                    <span class="text-danger">{{ $errors->first('address') }}<i class="fa fa-exclamation-circle" aria-hidden="true"></i></span>
                                                    @endif
                                                </div>
                                            </div>
                                        </div>
