...
<section class="customer_profile_section">
    <div class="padding-30">
        ...
        <form method="POST" action="{{__('routes.employer-updateemployee')}}" enctype="multipart/form-data" id="profile-form">
            @csrf
            <div class="row">
                <div class="col-lg-12">
                                    ...
                                    <div class="col-lg-3 col-md-4">
                                        <div class="profile-pic-wrapper">
                                            <div class="pic-holder">
                                                ...
                                                <input class="uploadProfileInput_emp" type="file" name="image" id="emp_image" accept="image/*" style="opacity: 0; width:0; visibility: hidden;"  />
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6 col-md-12">
                                                <div class="form-group form_dv_wrap">
                                                    ...
                                                    <input type="hidden" name="confirmed_email_update" id="confirmed_email_update" value="0">
                                                    @if ($errors->has('email'))
                                                    <span class="text-danger"> {{__('home.requiredMessage')}} <i class="fa fa-exclamation-circle" aria-hidden="true"></i></span>
                                                    @endif
                                                </div>
