          ...
          <div class="login_wrap">
            ...
            <form method="POST" auto-complete="off" action="{{__('routes.customer-signin')}}">
              ...
              <div class="heading_logo">
                ...
                <div class="logo_img">
                  <a href="{{asset('/')}}">
                    <img src="http://127.0.0.1:8000/asset/images/lion_werbe_gmbh_logo.webp" alt="empty">
                  </a>
                </div>
              </div>
              <div class="cred_txt">
              ...
              <div class="form_dv">
                ...
                <input type="password" placeholder="Password*" id="p1" autocomplete="new-password" name="password" required>
              ...
              <div class="lgg_resi">
                ...
                <div class="resig_lnkk">
                  ...
                  <a href="{{__('routes.customer-register')}}">{{__('home.create_account')}}</a>
                </div>
              </div>
