...
{
    public function embroideryForm()
    {
        return view('users.orders.embroideryorder');
    }
    ...
    public function vectorizeForm()
    {
        return view('users.orders.vectororder');
    }
            ...
            return DataTables::of($data)->addIndexColumn()
                ...
                ->addColumn('type', function ($row) {
                    ...
                    if ($row->type == "Embroidery") {
                        $type = '<img src="asset/images/reel-duotone.svg" alt="embroidery" style="width:18px">';
                    } else if ($row->type == "Vector") {
                        $type = '<img src="asset/images/bezier-curve-duotone.svg" alt="vector" style="width:18px">';
                    }
                    return $type;
                })
    ...
    public function importData(Request $request)
    {
        ...
        foreach ($uploads as $key => $current) {
            ...
            $special_instructions = "These are special instructions";
            $category_id = 1;
